...
for($i=0; $i<count($array); $i++) {
    if($i != count($array)-1) {
        if(intval($array[$i]['phoenix_v']) != 0) {
            ...
            echo '<td>'. $array[$i]['phoenix_k'] . '</td>';
            echo '<td>'. $array[$i]['phoenix_v'] . '</td>';
            echo '<td>'. $array[$i]['phoenix_prozent'] . '</td>';
            echo "</tr>";
        }
    } else {
        echo '<tr class="footer">';
        echo '<td></td><td></td><td></td><td></td><td></td><td>'.$array[$i]['phoenix_k'].'</td><td>'.$array[$i]['phoenix_v'].'</td><td></td>';
        echo "</tr>";
    }
}
?>
