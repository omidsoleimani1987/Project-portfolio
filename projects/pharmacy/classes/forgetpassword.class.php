    ...
    class ForgetPassword extends SetQuery {
        ...
        public function checkError() {
            ...
            if($check) {
                ...
                //creating the link:
                $url = "https://omid-soleimani.com/projects/pharmacy/app/resetpasscheck_page.php?selectorToken=" . $selectorToken . "&email=" .$this->email;
                $expire = date("U") + 3600;
                ...
                $headers = "From: Apotheke-App <omid@omid-soleimani.com>\r\n";
                $headers .= "Reply-To: omid@omid-soleimani.com\r\n";
                $headers .= "Content-type: text/html\r\n";

                mail($to, $subject, $message, $headers);
                header ("location: ./login_page.php?message=Wir haben Ihnen eine E-Mail gesendet, bitte überprüfen Sie Ihre E-Mail nach einer Weile.&status=success");
            }
        }
    }